...
/**
 * This is the model class for table "department_komisi".
 *
 * The followings are the available columns in table 'department_komisi':
 ...
 */
class DepartmentKomisi extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('auto_code, nama, create_date, create_by', 'required'),
			...
			array('auto_code, nama, create_date, create_by, edit_date, edit_by, is_delete, delete_date, delete_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pengurusEbpmsis' => array(self::HAS_MANY, 'PengurusEbpmsi', 'department_komisi'),
			'prokers' => array(self::HAS_MANY, 'Proker', 'department'),
		);
	}
	 ...
	 * @return DepartmentKomisi the static model class
	 */
