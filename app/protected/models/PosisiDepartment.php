...
/**
 * This is the model class for table "posisi_department".
 *
 * The followings are the available columns in table 'posisi_department':
 ...
 */
class PosisiDepartment extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('auto_code, posisi, create_date, create_by', 'required'),
			...
			array('auto_code, posisi, create_date, create_by, edit_date, edit_by, is_delete, delete_date, delete_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pengurusEbpmsis' => array(self::HAS_MANY, 'PengurusEbpmsi', 'posisi'),
		);
	}
	 ...
	 * @return PosisiDepartment the static model class
	 */
